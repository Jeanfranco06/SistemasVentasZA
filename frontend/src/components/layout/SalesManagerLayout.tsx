    ...
    <>
      <div className="p-5 border-b border-slate-200">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-base font-extrabold text-slate-800 tracking-tight">Gerente Ventas</h1>
            <p className="text-[10px] text-slate-400 font-semibold uppercase tracking-wider">Panel Comercial</p>
          </div>
        </div>
    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen">
        <header className="lg:hidden bg-white border-b border-slate-200 px-4 py-3 flex items-center justify-between sticky top-0 z-30 shadow-sm">
          ...
          <span className="font-bold text-slate-800 text-sm">Gerente de Ventas</span>
          <div className="w-9" />
        </header>
